...
```{r}
options(bitmapType = "cairo") #FOR THE PLOTS
```
...
```{r}
### MELANOMA MA-PLOT ----
png(file.path(plots_dir, "DEXSeq_MA_Plot_Melanoma.png"),
    width = 8, height = 6, units = "in", res = 300)
plotMA(dexseq_res_melanoma,
       main = "DEXSeq MA Plot – Melanoma",
       cex = 0.5)
dev.off()
### BLADDER MA-PLOT ----
png(file.path(plots_dir, "DEXSeq_MA_Plot_Bladder.png"),
    width = 8, height = 6, units = "in", res = 300)
plotMA(dexseq_res_bladder,
       main = "DEXSeq MA Plot – Bladder",
       cex = 0.5)
dev.off()

### MELANOMA MA-PLOT (solo schermo) ----
plotMA(dexseq_res_melanoma,
       main = "DEXSeq MA Plot – Melanoma",
       cex = 0.5)

### BLADDER MA-PLOT (solo schermo) ----
plotMA(dexseq_res_bladder,
       main = "DEXSeq MA Plot – Bladder",
       cex = 0.5)
